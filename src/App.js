...
import './screen.css';
import { BookFilled, SketchOutlined } from '@ant-design/icons';
        ...
        <Layout>
          <Header className="header" style={{color:"#e89a3c" ,height: "100px" }}>
            <div className="headertext">
              <label><SketchOutlined  style={{color:"#FFCA09" ,fontSize:"40px", marginRight:"10px"}} />Numerical Method</label>
            </div>
          </Header>
          <Layout>
            <Header className="header" style={{backgroundColor:"#FFCA09" ,height:"100"}}>
              <Menu theme="light" mode="horizontal" style={{backgroundColor:"#FFCA09" ,fontSize:"40px"}}>
